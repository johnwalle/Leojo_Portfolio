...
const Project1 = () => {
    return (
        <div class="project_sub_container p-12 flex flex-col md:flex-row gap-8 items-center justify-evenly">

            <div className="img__container">
                <div className="img__card">
                    <img className='project_card' src="https://via.placeholder.com/300x200" alt="Product Image" class="w-full rounded-lg shadow-md" />
                </div>
            </div>
